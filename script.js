const questionsQuiSerait = [
    "Qui serait Joueur 1 dans « Le Parrain » ?",
    "Qui serait Joueur 2 dans « Le Roi Lion » ?",
    "Qui serait Joueur 1 dans « La Haine » ?",
    "Qui serait Joueur 2 dans « Game of Thrones » ?",
    "Qui serait Joueur 1 dans « Pulp Fiction » ?",
    "Qui serait Joueur 2 dans « La Belle et la Bête » ?",
    "Qui serait Joueur 1 dans « Les Intouchables » ?",
    "Qui serait Joueur 2 dans « Breaking Bad » ?",
    "Qui serait Joueur 1 dans « Forrest Gump » ?",
    "Qui serait Joueur 2 dans « Aladdin » ?",
    "Qui serait Joueur 1 dans « Bienvenue chez les Ch'tis » ?",
    "Qui serait Joueur 2 dans « Friends » ?",
    "Qui serait Joueur 1 dans « Les Évadés » ?",
    "Qui serait Joueur 2 dans « La Petite Sirène » ?",
    "Qui serait Joueur 1 dans « Le Fabuleux Destin d'Amélie Poulain » ?",
    "Qui serait Joueur 2 dans « Stranger Things » ?",
